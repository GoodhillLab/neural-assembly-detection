% # (JM) MODIFIED FROM ORIGINAL FUNCTION 'AssembliesActivations'

function AssembliesActivations( filenameCLUSTER )
...
threshSignifMatchIndex = 0.01; % # threshSignifMatchIndex= str2num(answer{1});
...
if strcmp(clustering.method,'PCA-promax')
    save(filenameCLUSTER,'clustering','assembliesCells', 'assembliesVectors', 'PCsRot', 'confSynchBinary', 'matchIndexTimeSeries', 'matchIndexTimeSeriesSignificance','matchIndexTimeSeriesSignificant','matchIndexTimeSeriesSignificantPeaks','threshSignifMatchIndex','zMaxDensity')
else
