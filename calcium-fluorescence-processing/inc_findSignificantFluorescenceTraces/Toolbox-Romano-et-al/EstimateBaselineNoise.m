% # (JM) MODIFIED FROM ORIGINAL FUNCTION 'EstimateBaselineNoise'

function [deltaFoF, mu, sigma, params]=EstimateBaselineNoise(deltaFoF, params)
...
ansMethod = params.BaselineNoiseMethod; % # params.BaselineNoiseMethod=ansMethod;
